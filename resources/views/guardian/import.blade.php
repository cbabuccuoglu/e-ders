...
@section('title','Velileri İçeri Aktarma')
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title">Veli İmport İşlemleri</h6>
                    ...
                    <div class="card-body">
                        {{Form::open(['route'=>'imported.guardian' , 'method'=>'POST' , 'files'=> 'true' , 'class' => 'form-horizontal'])}}
                        @csrf
