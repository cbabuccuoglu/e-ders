...
@section('title','Öğrenci Tanımlama')
            ...
            <div class="col-lg-12">
               ...
               <div class="card">
                            <div class="card-header header-elements-inline">
                                <h6 class="card-title">Yeni Öğrenci Tanımla</h6>
                            ...
                            <div class="card-body">
                        {{Form::open(['route'=>'student.store' , 'method'=>'POST' , 'class' => 'form-horizontal'])}}
                        @csrf
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <input type="text"  required  class="form-control" name="tcno" placeholder="Lütfen Sisteme Giriş Yapacak Öğrenci Numarası Giriniz" value="{{ old('tcnp') }}">
                                    </div>
