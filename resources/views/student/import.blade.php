...
@section('title','Öğrencileri İçeri Aktarma')
            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-header header-elements-inline">
                        <h6 class="card-title">Öğrenci İmport İşlemleri</h6>
                    ...
                    <div class="card-body">
                        {{Form::open(['route'=>'imported.student' , 'method'=>'POST' , 'files'=> 'true' , 'class' => 'form-horizontal'])}}
                        @csrf
