...
@section('title','Öğretmen Düzenleme')
            ...
            <div class="col-lg-12">
               ...
               <div class="card">
                            <div class="card-header header-elements-inline">
                                <h6 class="card-title">Öğretmen Düzenleme İşlemleri</h6>
                        ...
                        @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="tcno" placeholder="Lütfen Sisteme Giriş Yapacak Öğretmen Numarasını Giriniz" value="{{$teacher->tcno}}">
                                </div>
                                      <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        {!! Form::select('lesson_id', $lesson, $teacher->lesson_id ?? NULL, ['placeholder' => 'Ders Seçiniz', 'class' => 'form-control select2']) !!}
                                    </div>
