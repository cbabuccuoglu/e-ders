            ...
            <div class="col-lg-12">
               ...
               <div class="card">
                        ...
                        @csrf
                                ...
                                <div class="form-group">
                                    <label>Sınav Tipini Seçinizi</label>
                                    <select name="trial_type" required class="form-control" >
                                        <option value="">Lütfen Seçiniz </option>
                                        <option value="1">Klasik Deneme</option>
                                        <option value="2">TYT Denemesi</option>
                                        <option value="3">AYT Denemesi </option>
                                    </select>
                                </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"  required  class="form-control" name="name" placeholder="Lütfen Deneme Sınavı Giriniz" value="{{ old('name') }}">
                                    </div>
                                    <div class="form-group">
                                        <label>Deneme Sınavı Baz Puan:</label>
                                        <input type="text"  required  class="form-control" name="startpoint" placeholder="Lütfen Baz Puan Giriniz (Örn:182.500)" value="{{ old('startpoint') }}">
                                    </div>
                                    <input type="text" class="form-control" name="time" placeholder="Lütfen Sıanv Süresini Giriniz (Örn:120)"  value="{{ old('time') }}">
                                <div class="form-group">
                                    <label>Doğru Yanlış Türü:</label>
                                    <select name="dyType"  required  class="form-control" required >
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="resulttype"  required  class="form-control" required >
                                        <option value="">Lütfen Seçiniz </option>
                                ...
                                <div class="form-group">
                                    <label>Öğrenciler Soruları Görsün mü?</label>
                                    <select name="opticsType"  required  class="form-control" >
                                        <option value="">Lütfen Seçiniz </option>
                                        <option value="1">Öğrenciler Soruları Görmesin [Sadece Optik]</option>
                                        <option value="2">Öğrenciler Soruları Görsün</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>Sınav Başlangıç Zamanı</label>
                                    <input type="datetime-local"  required  class="form-control" name="start_date" value="{{ old('startpoint') }}">
                                </div>

                                <div class="form-group">
                                    <label>Sınav Bitiş Zamanı</label>
                                    <input type="datetime-local"  required  class="form-control" name="finish_date" value="{{ old('startpoint') }}">
                                </div>
