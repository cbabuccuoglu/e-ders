...
@section('title','Deneme Sınavını Düzenleme')
            ...
            <div class="col-lg-12">
               ...
               <div class="card">
                            <div class="card-header header-elements-inline">
                                <h6 class="card-title">Deneme Sınavı Düzenleme İşlemleri</h6>
                        ...
                        @csrf
                                ...
                                <div class="form-group">
                                    <label>AYT-TYT Hesaplansın mı?</label>
                                    <select name="trial_type" required class="form-control" >
                                        <option value="">Lütfen Seçiniz </option>
                                        <option value="1" @if($trialexam->trial_type==1) selected @endif>Klasik Deneme</option>
                                        <option value="2" @if($trialexam->trial_type==2) selected @endif>TYT Denemesi</option>
                                        <option value="3" @if($trialexam->trial_type==3) selected @endif>AYT Denemesi </option>
                                    </select>
                                </div>
                                     <div class="form-group">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label>Deneme Sınavı Süresi (Dakika Cinsinden):</label>
                                    <input type="text" class="form-control" name="time" placeholder="Lütfen Sıanv Süresini Giriniz (Örn:120)"  value="{{$trialexam->time}}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="opticsType"  required  class="form-control" >
                                        <option value="">Lütfen Seçiniz </option>
                                        <option value="1" @if($trialexam->opticsType==1) selected @endif>Öğrenciler Soruları Görmesin [Sadece Optik]</option>
                                        <option value="2" @if($trialexam->opticsType==2) selected @endif>Öğrenciler Soruları Görsün</option>
                                    </select>
                                </div>
                                @php
                                    $trialexam->start_date=str_replace(' ','T',$trialexam->start_date);
                                    $trialexam->finish_date=str_replace(' ','T',$trialexam->finish_date);
                                @endphp
                                <div class="form-group">
