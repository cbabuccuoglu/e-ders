            ...
            <div class="col-lg-12">
               ...
               <div class="card">
                            <div class="card-header header-elements-inline">
                                <h6 class="card-title">Yeni Video Tanımla</h6>
                        ...
                        @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"  required  class="form-control" name="name" placeholder="Lütfen Video İsmini Giriniz" value="{{ old('name') }}">
                                    </div>
                                    <div class="form-group">
                                        <label>Video Linki:</label>
                                        <input type="text"  required  class="form-control" name="videoslink" placeholder="Lütfen Video Linkini Giriniz" value="{{ old('videoslink') }}">
                                    </div>
